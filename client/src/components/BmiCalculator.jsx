...
import ResultCard from './ResultCard';
    ...
    let resultMessage = "Your bmi is " + bmi.toFixed(1) + " and your bmi category is falls in " + bmiCategory;
    const additionalMessage = ' Here is an article to tell you about bmi and your category ';
  ...
  const closeResultCard = () => {
    ...
    return(
            <div className="container-xl w-full mx-auto my-8 p-20 bg-white rounded-md shadow-md Modal p-4 dark:bg-slate-800">
              ...
              {isResultCardOpen && <ResultCard result={result} onClose={closeResultCard} />}
