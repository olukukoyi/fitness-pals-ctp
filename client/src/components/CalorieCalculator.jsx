...
const CalorieCalculator = () => {
  ...
  return (
    <div className="container-lg w-full mx-auto my-8 p-6 bg-white rounded-md shadow-md">

      <h2 className="text-2xl font-bold mb-4">Calorie Calculator</h2>

      <form>

      <div className="row">{/*Row 1 - Weight */}
        <div className="mb-12">
      ...
      <div className="row">{/*Row 2 - Gender */}
        <div className="mb-12">
      ...
      <div className="grid grid-cols-3 gap-3"> {/*Row 3 - height & age */}
        <div className="mb-4">
            <label htmlFor="feet" className="block text-sm font-medium text-gray-600">
              Height (feet):
            </label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label htmlFor="inches" className="block text-sm font-medium text-gray-600">
              Height (inches):
            </label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label htmlFor="age" className="block text-sm font-medium text-gray-600">{/*age input*/}
              Age :
            </label>
            <input
              type="number"
      ...
      <div className="mb-4 col-span-6"> {/*Row 4 - activity level */}
      ...
      {caloriesResult !== null && (
        <div className="mt-4 p-4 bg-green-100 rounded-md">
          <p className="text-green-700">Estimated Daily Calories: {caloriesResult.toFixed(2)}</p>{/*OUTPUT*/}
        </div>
        )}
</div>
  );
